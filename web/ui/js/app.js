...
// bootstrap angular
TM.config(['$routeProvider', '$locationProvider', '$httpProvider',
    function($routeProvider, $locationProvider, $httpProvider) {
        ...
        $routeProvider.when('/demoEason4', {
            templateUrl: 'partials/demoEason4.html'
        });
...
TM.run(function($rootScope, $location, $http, $timeout, AuthService, RESTService) {
    ...
    $rootScope.postBoard = [{
        ...
        status: "info",
        type: "R",
        desc: "Sed do eiusmod tempor incididunt ut",
        date: "2014/09/13"
    }, {
        status: "danger",
        type: "T",
        ...
        status: "warning",
        type: "C",
        desc: "Velit esse quam nihil molestiae consequatur",
        date: "2014/09/15"
    }];
    $rootScope.latest = [{
        id: "1",
